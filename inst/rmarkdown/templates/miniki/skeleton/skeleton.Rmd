---
title: A minimal presentation template,
subtitle: with emphasis on typography
author:
  - name: Alessandro Gasparini
    inst: "1,2"
  - name: Another Author
    inst: 2
sauthor: alessandro.gasparini@ki.se
institute:
  - inst: 1
    institute: Department of Medical Epidemiology and Biostatistics, Karolinska Institutet, Stockholm, Sweden
  - inst: 2
    institute: Department of Something, University of Somewhere, Somewhere, Nice Country
date: "`r Sys.Date()`"
output: templates::miniki
aspectratio: 32
---
